...
// var lala = new newDate().addDays(-1);

// BookRecord.makeBooking(101, 1, lala.toHyphenString(), '2:00:00', '4:00:00').then(resul=>{
// 	console.log(resul);
// })
...
// 	console.log(resul);
// })
// BookRecord.BookingByAGroupInNextNDays(1, 4, []).then(resul=>{
// 	console.log(JSON.stringify(resul));
// })

// var lala = new newDate();

console.log(newDate.datesHyphenString(4));